...
void Protocol::SendStudyAlert(const std::string& text, const std::string& request_id) {
    cJSON* root = cJSON_CreateObject();
    cJSON_AddStringToObject(root, "session_id", session_id_.c_str());
    cJSON_AddStringToObject(root, "type", "study_alert");
...
void Protocol::SendStudyStageSetup() {
    cJSON* root = cJSON_CreateObject();
    cJSON_AddStringToObject(root, "session_id", session_id_.c_str());
    cJSON_AddStringToObject(root, "type", "study_stage_setup");
    cJSON_AddStringToObject(root, "state", "ready");
